$(document).ready(function(){
    ...
    red.annotation = {
		...
		getAnnotationIdFromContentTop:function(){
		   var scrollTop = $(window).scrollTop();
		   var screenHeight = document.body.clientHeight;
		   var highlightArr = $("mark.highlight");
		   var id = "", obj=this;
		   $("mark.highlight").each(function (e) {
		       var elementOffsetTop = obj.pageY(this);
               if (elementOffsetTop > scrollTop && elementOffsetTop < scrollTop + screenHeight)
               {
		...
		addPublicationCover:function(publicationCoverString){

		var publicationCoverDiv = document.getElementById('PublicationCoverForPrint');
		publicationCoverDiv.innerHTML = publicationCoverString;
		this.setPageContainerMarginBottomBeforePrint();
		},

		deletePublicationCover:function(){

		var publicationCoverDiv = document.getElementById('PublicationCoverForPrint');
		publicationCoverDiv.innerHTML = null;
		this.setPageContainerMarginBottomAfterPrint();
		},
}
