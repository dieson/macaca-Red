			...
			var targetEle = $("span[data-refpt_id='"+scrollToData+"']");
 			...
 			if(targetEle.length > 0){
				...
				targetEle.css("display","none");
  				...
  				if($("div[id='"+scrollToData+"']").length > 0){ //data-value
 					$("div[id='"+scrollToData+"']").css("display","block");
					$(window).scrollTo($("div[id='"+scrollToData+"']"));
					$("div[id='"+scrollToData+"']").css("display","none");
 				}
 			}
 		}
 	},
